      ...
      <div class="card-body">
        ...
        <div class="text-end">
          <div class="btn-group" role="group" aria-label="Controls">
            ...
            <button
              class="btn btn btn-outline-secondary"
              @click="$emit('return', initialLevel)"
            >
              Close
            </button>
          </div>
...
export default {
  ...
  methods: {
    setName(levelName) {
      validateName(levelName).then((isValid) => {
    ...
    setWidth(width) {
      validateWidth(width).then((isValid) => {
    ...
    setHeight(height) {
      validateHeight(height).then((isValid) => {
    ...
    setMines(mines) {
      ...
      validateMines(width, height, mines).then((isValid) => {
    ...
    getUpdatedLevel() {
      const level = this.isValidSettings()
        ? this.updatedLevel
        : this.initialLevel;
